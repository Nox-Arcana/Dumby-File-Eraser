...
msg.vbs
echo.
echo msgbox"Recuerda haber cambiado el nombre de la ruta para obtener tu usuario. Si no lo has hecho, edita este programa y reemplaza esta linea por tu nombre de usuario C:\Users\TU_NOMBRE_DE_USUARIO\",vbExclamation , "j.A"> msg.vbs
msg.vbs
echo.
goto Ask
...
@RD /S /Q "C:\Users\juana\AppData\Roaming\Microsoft\Windows\Recent\"
@RD /S /Q "C:\Users\juana\AppData\Local\Temp"
